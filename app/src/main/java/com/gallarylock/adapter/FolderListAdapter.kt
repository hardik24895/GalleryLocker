...
class FolderListAdapter(val folderList: ArrayList<FolderListModal>, val context: Context,
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(
            ...
            val f = File(Environment.getExternalStorageDirectory(), APPLICATON_FOLDER_NAME +"/" +  Folder.name )
          ...
          //  val textViewAddress  = itemView.findViewById(R.id.textViewAddress) as TextView
            ...
            imgOption.setOnClickListener {listener.onOptionItemSelect(adapterPosition,Folder,itemView)  }
